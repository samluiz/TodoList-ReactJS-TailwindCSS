  ...
  return (
    <ul className=" h-screen absolute right-28">
          {allTodos.map((e: any, key: number) => {
            return (
              <div key={key} className=" bg-indigo-300 bg-opacity-10 w-72 flex justify-start items-left flex-col break-words rounded-md shadow-lg hover:transform-cpu px-4 py-1 mt-2 duration-200 hover:scale-105 hover:bg-opacity-40">
